...
func TestGetField(t *testing.T) {
	...
	testutils.Case(t, "returns correct types")
...
func TestSetField(t *testing.T) {
	...
	testutils.Case(t, "successfully sets fields")
	...
	testutils.Case(t, "throws error for type mismatch")
	err := m.SetField("1", 1)
...
func TestSetFields(t *testing.T) {
	...
	testutils.Case(t, "successfully sets all fields")
	var field3 float32 = 3.0
	...
	testutils.Case(t, "successfully sets some fields")
	fieldValues = mutator.MappedFieldValues{
		"1": "test2",
	}
